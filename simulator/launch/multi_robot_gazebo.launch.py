...
def generate_launch_description():
    ...
    turtlebot3_multi_robot = get_package_share_directory("simulator")
    ...
    world = os.path.join(turtlebot3_gazebo_path,
    ...
    urdf = os.path.join(
        turtlebot3_description_path, "urdf", urdf_file_name
    )
